...
# URL chứa bảng HTML
url = "https://diemthi.tuyensinh247.com/de-an-tuyen-sinh/dai-hoc-ngoai-ngu-ha-noi-QHF.html#nganh-dao-tao"
...
output_path = os.path.join(output_dir, "ULIStuyensinh.csv")
